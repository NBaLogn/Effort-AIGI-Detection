...
if __name__ == "__main__":
    ...
    log_path = f"/Users/logan/Developer/WORK/DEEPFAKE_DETECTION/Effort-AIGI-Detection/DeepfakeBench/preprocessing/logs/{dataset_name}.log"
    ...
    ## Celeb-DF-v1
    elif dataset_name == "Celeb-DF-v1" or dataset_name == "Celeb-DF-v2":
    ...
    ## DFDC-test
        ...
        sub_train_dataset_names = ["dfdc_train_part_" + str(i) for i in range(50)]
